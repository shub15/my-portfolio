        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div className="flex justify-between items-center mb-12">
              ...
              <span className="text-neutral-600 group-hover:text-[#0077b5] group-hover:-translate-y-1 group-hover:translate-x-1 transition-all duration-300">
                ↗
              </span>
            </div>
            <div>
          ...
          >
            <div className="flex justify-between items-center mb-12">
              ...
              <span className="text-neutral-600 group-hover:text-white group-hover:-translate-y-1 group-hover:translate-x-1 transition-all duration-300">
                ↗
              </span>
            </div>
            <div>
